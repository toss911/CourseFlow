                  ...
                  {adminCourses.map((course, key) => {
                    return (
                      ...
                      <Tr key={key}>
                        ...
                        <Td>
                          <Text variant="body2" textColor="black">{course.course_name}</Text>
                        </Td>
                        <Td>
                          <Text variant="body2" textColor="black">{course.lessons_count} Lessons</Text>
                        </Td>
                        <Td>
                          <Text variant="body2" textColor="black">{course.price.toLocaleString("en", { minimumFractionDigits: 2 })}</Text>
                        </Td>
                        <Td>
                          <Text variant="body2" textColor="black">{course.created_date}</Text>
                        </Td>
                        <Td>
                          <Text variant="body2" textColor="black">{course.updated_date}</Text>
                        </Td>
                        <Td>
                          <Flex gap="20px">
                            <Image
